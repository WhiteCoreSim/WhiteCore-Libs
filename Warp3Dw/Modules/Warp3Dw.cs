...
namespace Warp3Dw
{
	public partial class Warp3D
	{
		...
		Hashtable _plugins = new Hashtable ();
		...
		void Warp3D_Load (object sender, EventArgs e)
		{

		}

		// void Warp3D_KeyDown( object sender, KeyEventArgs e )
		//{
		//    _keargs = e;
		//    _controlkey = e.Control;
		//}

		// void Warp3D_KeyUp( object sender, KeyEventArgs e )
		//{
		//    _keargs = e;
		//    _controlkey = e.Control;
